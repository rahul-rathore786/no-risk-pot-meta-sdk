    ...
    <div className="home-container">
      ...
      <div className="lottery-stats">
        ...
        <div className="stat-card">
          ...
          <div className="stat-value">{lotteryData.totalTickets} USDC</div>
        </div>

        <div className="stat-card">
          <h3>Interest Pool</h3>
          <div className="stat-value highlight">
            {parseFloat(lotteryData.interestPool).toFixed(2)} USDC
          </div>
        </div>
      </div>
        ...
        <div className="dashboard-stats">
          ...
          <div className="dashboard-card">
            ...
            <div className="dashboard-value">
              {parseFloat(lotteryData.pyusdBalance).toFixed(2)} USDC
            </div>
          </div>
      ...
      <div className="how-it-works">
        ...
        <div className="steps-flow">
          <div className="step">
            ...
            <h3>Buy Tickets</h3>
            <p>Purchase up to 10 tickets at 1 USDC each.</p>
          </div>
